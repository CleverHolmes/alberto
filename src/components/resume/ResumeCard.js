...
const ResumeCard = ({ title, subTitle, result, des }) => {
  return (
    <div className="w-full group flex">
      ...
      <div className="w-full bg-black bg-opacity-20 hover:bg-opacity-30 duration-300 rounded-lg py-8 px-4 lgl:px-8 flex flex-col justify-center gap-6 lgl:gap-10 shadow-shadowOne">
